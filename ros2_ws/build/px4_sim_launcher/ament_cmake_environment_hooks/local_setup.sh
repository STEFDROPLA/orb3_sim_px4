...
: ${AMENT_CURRENT_PREFIX:="/workspaces/prova_container/ros2_ws/install/px4_sim_launcher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_sim_launcher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_sim_launcher/environment/path.sh"
